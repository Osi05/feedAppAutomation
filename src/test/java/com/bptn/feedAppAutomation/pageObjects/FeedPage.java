...
public class FeedPage extends BasePage {
	...
	public void setFeedContent(String content) {
		...
		this.driverManager.getDriver().findElement(this.txtContent).sendKeys(contentWithTestId);
	}

	public void clickSend() {
		this.driverManager.getDriver().findElement(this.xPathSendBtn).click();
	}
	...
	public void navigateToMyFeeds(String myFeedsTitle) {
		this.driverManager.getDriver().findElement(By.linkText(myFeedsTitle)).click();
	}
